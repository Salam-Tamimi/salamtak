                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp"  data-wow-delay="0.1s">
                        <div class="service-item rounded h-100">
                            <div class="d-flex justify-content-between">
                                ...
                                <a class="service-btn" href="{{ url('/appointments', ['department_id' => $department->id]) }}">
                                    <i class="fa fa-link fa-2x"></i>
                                </a>
                            </div>
                            <div class="p-5">
                                <h4 class="mb-3">{{ $department->name }}</h4>
                               <a href="href="{{ url('/appointments', ['department_id' => $department->id]) }}"><span>احجز موعد عند {{ $department->name }}</span></a> 
                            </div>
                        </div>
                    </div>
                    @endforeach
