...
<div class="container">
    <h1>تعديل معلومات قسم </h1>
    <form method="POST" action="{{ route('departments-admin.update', $department->id) }}" enctype="multipart/form-data" style="width: 80%; margin: 50px auto;">
        @csrf
        @method('PUT')
