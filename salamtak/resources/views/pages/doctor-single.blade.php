...
@section('content')
    ...
    <strong class="d-flex">
        ...
        <h4 style="color: rgb(207, 206, 206);">أخصائي عظام ومفاصل</h4> 
    <div>
    ...
    <div class="d-flex">
        ...
        <h5> إربد - شارع الأمير حسن - مستشفى ابن النفيس</h5>
    </div>
    <div class="d-flex">
    ...
    <div class="px-5 py-2 me-5" style="width: 60%; background-color: rgb(238, 238, 238);">
        <div>
            <br><h4>الخبرة المهنية :</h4>
             الدكتور محمد أحمد استشاري العظام و المفاصل و العمود الفقري في اربد-مستشفى ابن النفيس يجري كافة العمليات المتعلقة بهذا التخصص ويعالج الحالات التي تحتاج جبيرة ويقدم العلاج بالتردد الحراري، الدكتور،حصل على درجة البكالوريس في الطب و الجراحة العامة من جامعة العلوم والتكنولوجيا ، لدى الدكتور محمد سنوات طويلة من الخبرة في المستشفيات الأرنيةو يعمل حاليا في عيادته الخاصة في مستشفى ابن النفيس.
        </div><br>
    </div>
<hr>
<!-- *******feedback******* -->
