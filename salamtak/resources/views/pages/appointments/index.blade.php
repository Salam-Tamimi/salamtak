...
<div id="blur">
  ...
  <div class="m-4 justify-content-center">
    <div class="row m-4">
        ...
        @endphp
        <div class="card  col-lg-3 col-md-6 col-sm-12 my-4" style="border: 1px solid #dee2e6; box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px;margin-right:5%;">
