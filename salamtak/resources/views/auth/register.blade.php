...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="{{ asset('/img/Medical Care Logo 2 .png') }}">
                    ...
                    <div class="form-container register">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="mobile" class="form-control" placeholder="٠٧٧٧٧٧٧٧٧" pattern="07[0-9]{8}">
                            </div>
                            
                            <div class="check-terms">
                                {{-- <input type="checkbox" class="checkbox">
                                <span class="check-label ">&nbsp; أوافق على الشروط  </span> --}}
                                <button type="submit" class="btn signup">إنشاء حساب</button>
                            </div>
                                    <hr>
                                    <h5 class="text-center">إنشاء حساب باستخدام</h5>
                            ...
                            <span class="signin-link">أمتلك حساب بالفعل <a href="login.html">تسجيل دخول</a></span>
                        </form>
                    </div>
                </div>
            </div>
